...
export const metadata = {
  ...
  description: 'Join HiPop Markets and connect with more customers at farmers markets, vintage clothing markets, and artisan fairs. Manage your presence, track analytics, and grow your local business.',
  keywords: 'farmers market vendors, vintage clothing vendors, artisan vendors, vendor management, local business, market analytics, vendor platform, craft vendors',
};
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Connect with Atlanta-area farmers markets, artisan fairs, vintage clothing markets, craft shows, and all types of pop-up communities. HiPop's permission system, 
                      ...
                      <div className="px-6 pb-14 pt-6">
                        ...
                        <div className="text-white text-sm space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-hipop-secondary font-semibold">↗ +23%</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Customer Favorites</span>
                            <span className="text-hipop-primary font-semibold">47</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span>Next Market</span>
                            <span className="text-hipop-accent">Saturday 8am</span>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex items-center gap-x-4">
                <div className="h-12 w-12 rounded-full bg-hipop-surface-variant flex items-center justify-center">
                  <UserGroupIcon className="h-6 w-6 text-hipop-primary" />
                </div>
                <div>
              ...
              <div className="mt-4 text-sm text-hipop-primary font-medium">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex items-center gap-x-4">
                <div className="h-12 w-12 rounded-full bg-hipop-surface-variant flex items-center justify-center">
                  <ChartBarIcon className="h-6 w-6 text-hipop-primary" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="flex items-center gap-x-4">
                <div className="h-12 w-12 rounded-full bg-hipop-surface-variant flex items-center justify-center">
                  <MegaphoneIcon className="h-6 w-6 text-hipop-primary" />
                </div>
                <div>
                  ...
                  {vendor.categories.length > 0 && (
                    <div className="mt-4 flex flex-wrap gap-2">
                      {vendor.categories.slice(0, 3).map((category) => (
                        <span
                          key={category}
                          className="inline-flex items-center rounded-md bg-hipop-surface-variant px-2 py-1 text-xs font-medium text-hipop-primary ring-1 ring-inset ring-[#558B6E]/10"
                        >
                          {category}
                        </span>
                      ))}
